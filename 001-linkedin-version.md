...
I've spent the past year and a half building LLM apps, from RAG pipelines to agentic workflows. Here's what shifted my thinking.
...
I'm not saying RAG is dead. But for many use cases, a capable model with simple search tools can outperform a sophisticated retrieval pipeline.
