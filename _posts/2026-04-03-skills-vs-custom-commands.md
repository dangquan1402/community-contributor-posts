---
layout: post
title: "Skills vs Custom Commands in Claude Code — When to Use Which"
date: 2026-04-03
---
...
Custom commands are the legacy format. Skills are the current standard and a strict superset. [The official docs [1]](https://docs.anthropic.com/en/docs/claude-code/skills) are explicit about this — "Custom commands have been merged into skills. Your existing `.claude/commands/` files keep working. Skills add optional features." But "strictly better" doesn't always mean "always use the complex option."
